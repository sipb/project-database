...
class EnvironmentOverrider:
    def __init__(self, keys=None):
        ...
        """
        if keys is None:
            keys = ["SSL_CLIENT_S_DN_Email", "HTTP_HOST", "REQUEST_URI"]
        self.keys = keys
...
class EnvironmentOverrideTestCase(MultiManagerTestCase):
    def __init__(self, *args, **kwargs):
        ...
        """
        super().__init__(*args, managers=[EnvironmentOverrider()], **kwargs)
...
class DatabaseWipeTestCase(DatabasePopulatorMixin, MultiManagerTestCase):
    def __init__(self, *args, **kwargs):
        ...
        """
        super().__init__(*args, managers=[DatabaseWiper()], **kwargs)
